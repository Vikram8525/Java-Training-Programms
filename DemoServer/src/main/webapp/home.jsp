...
<body>
  ...
  <main>
    <div class="form-container">
      <article>
        <h1> Pirate Registration Form</h1>
        <form action="DemoServlet">
          <table>
            ...
            <tr>
              ...
              <td><input type="date" id="date" name="date" required min="1923-01-01" max="2023-01-01"></td>
            </tr>
            <tr>
              <td><label for="password"><h2>Password:<span style="color: crimson;">*</span></h2></label></td>
              <td><input type="password" id="password" name="password" required minlength="8" maxlength="16" placeholder="Enter your password"></td>
            </tr>
            <tr>
              <td><label for="repassword"><h2>Retype Password: <span style="color: crimson;">*</span></h2></label></td>
              <td><input type="password" id="repassword" name="repassword" required minlength="8" maxlength="16" placeholder="Enter your password again"></td>
            </tr>
